<template>
    <aside :class="cls ? 'slow-wind' : 'fast-wind'">
...
aside.slow-wind .windmill-pole-ellipses-wrapper {
    -webkit-animation-play-state: running;
    -moz-animation-play-state: running;
    animation-play-state: running;
}

aside.slow-wind .windmill-pole-ellipses-wrap {
    -webkit-animation-play-state: paused;
    -moz-animation-play-state: paused;
    animation-play-state: paused;
}
...
aside.slow-wind .clouds-wind-wrapper {
    -webkit-animation-play-state: paused;
    -moz-animation-play-state: paused;
    animation-play-state: paused;
}

aside.slow-wind .clouds-wind-wrap {
    -webkit-animation-play-state: running;
    -moz-animation-play-state: running;
    animation-play-state: running;
}
...
aside.slow-wind .tree-wrap {
    transform: skewX(-10deg);
}

aside.slow-wind .tree {
